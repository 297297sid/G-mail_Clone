...
export default function Events() {
  ...
  return (
      <div>
     <img  onClick={handleOpen} style={{width:"1.4vw",paddingTop:"2vw"}} src={Event}/>
        ...
        <Box sx={style}>
          <Typography sx={{fontSize:"2vw",}} >
            ...
            Add Event...
                  ...
                  <br/>
                  <input placeholder="Event" style={{outline:"none",fontSize:"1vw",width:"11vw",height:"1.5vw" ,marginTop:"0.5vw",border: "1px solid #000",}} />
                  <input type="date"placeholder="Notes" style={{outline:"none",fontSize:"1vw",width:"11vw",height:"1.5vw" ,marginTop:"0.5vw",border: "1px solid #000",}} />
