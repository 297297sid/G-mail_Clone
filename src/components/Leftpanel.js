    ...
    return (
        ...
        "17vw"}}>
            ...
            <div style={{marginLeft:"0.8vw",width:"12vw",display:"flex" ,alignItems:"center"}}>
                ...
                <h4 style={{ fontSize:"1.3vw",marginLeft:"1.6vw",fontWeight:"400",fontSize:"1.3vw" }} > Inbox</h4>
            </div>
            <div style={{marginLeft:"0.8vw",width:"12vw",display:"flex" ,alignItems:"center"}}>
                <img src={Starred} style={{ width: "1.2vw",marginLeft:"2vw" }} />
                <h4 style={{ fontSize:"1.3vw",marginLeft:"1.6vw",fontWeight:"400",fontSize:"1.3vw" }} > Starred</h4>
            </div>
            <div style={{marginLeft:"0.8vw",width:"12vw",display:"flex" ,alignItems:"center"}}>
                <img src={Snooze} style={{ width: "1.2vw",marginLeft:"2vw" }} />
                <h4 style={{ fontSize:"1.3vw",marginLeft:"1.6vw",fontWeight:"400",fontSize:"1.3vw" }} > Snoozed</h4>
            </div>
            <div style={{marginLeft:"0.8vw",width:"12vw",display:"flex" ,alignItems:"center"}}>
                <img src={Sent} style={{ width: "1.2vw",marginLeft:"2vw" }} />
                <h4 style={{ fontSize:"1.3vw",marginLeft:"1.6vw",fontWeight:"400",fontSize:"1.3vw" }} > Sent</h4>
            </div>
        </div>
